...
export const channelFormSchema = z
  .object({
    ...
    exclude_auto_test: z.boolean().optional(),
...
export function transformChannelToFormDefaults(
  ...
  return {
    ...
    concurrency_limit: channel.concurrency_limit ?? 10,
    test_model: channel.test_model || '',
    exclude_auto_test: channel.exclude_auto_test ?? false,
...
export function transformFormDataToCreatePayload(formData: ChannelFormValues): {
  ...
  const channel: Partial<Channel> = {
    ...
    concurrency_limit: formData.concurrency_limit ?? 10,
    test_model: formData.test_model || null,
    exclude_auto_test: formData.exclude_auto_test ?? false,
