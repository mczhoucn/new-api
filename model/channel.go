...
type Channel struct {
	...
	ExcludeAutoTest    *bool   `json:"exclude_auto_test" gorm:"default:false"`
...
func (channel *Channel) IsAutoTestExcluded() bool {
	return channel != nil && channel.ExcludeAutoTest != nil && *channel.ExcludeAutoTest
}
