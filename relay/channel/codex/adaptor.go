...
func (a *Adaptor) GetRequestURL(info *relaycommon.RelayInfo) (string, error) {
	if info == nil {
		return "", errors.New("codex channel: relay info is nil")
	}
	...
	default:
		return "", errors.New("codex channel: only /v1/responses, /v1/responses/compact, /v1/images/generations, /v1/images/edits and /v1/alpha/search are supported")
	}
